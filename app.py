...
# 1. സെർച്ച് എഞ്ചിനുകൾക്ക് സൈറ്റിനെ മനസ്സിലാക്കാൻ ഇത് സഹായിക്കും
st.set_page_config(
    page_title="KPSC Photo Maker - Online",
    page_icon="📸",
    menu_items={
        'Get Help': 'https://your-website-link',
        'About': "# KPSC ഫോട്ടോ എഡിറ്റർ. കേരള പി.എസ്.സി നിബന്ധനപ്രകാരം ഫോട്ടോ തയ്യാറാക്കാൻ സഹായിക്കുന്നു."
    }
)

# 2. ഗൂഗിൾ വെരിഫിക്കേഷൻ ടാഗ് (Meta Tag) ഇവിടെ നൽകുക
